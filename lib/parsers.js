...
var ClassExpression = x.ClassExpression,
    ...
    DefExpression = x.DefExpression,
    DefNamedExpression = x.DefNamedExpression,
    CallExpression = x.CallExpression,
    ...
    MakeNameExpression = x.MakeNameExpression,
    ...
    ConstantExpression = x.ConstantExpression,
    ...
    BinaryAndExpression = x.BinaryAndExpression,
    BinaryOrExpression = x.BinaryOrExpression,
    BinaryXorExpression = x.BinaryXorExpression,
    BinaryNotExpression = x.BinaryNotExpression,
    BinaryLeftShiftExpression = x.BinaryLeftShiftExpression,
    BinaryRightShiftExpression = x.BinaryRightShiftExpression;
