...
var JavaScriptNamespaceExpression = x.JavaScriptNamespaceExpression,
    JavaScriptQualifiedNameExpression = x.JavaScriptQualifiedNameExpression,
    DefNamedExpression = x.DefNamedExpression,
    MakeQualifiedCallExpression = x.MakeQualifiedCallExpression,
    QualifiedCallExpression = x.QualifiedCallExpression,
    CompositeExpression = x.CompositeExpression,
    MakeQualifiedNameExpression = x.MakeQualifiedNameExpression,
    QualifiedNameExpression = x.QualifiedNameExpression;
...
var rules = [
    ...
    get(':', ['a-z', 'A-Z', '_'], get(['a-z', 'A-Z', '0-9', '_']).zeroOrMore()).generate('Keyword', function (value) { return x.keyword(value) }),
    ...
    get('class', 'Name', 'Less', 'Name', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.klass(values[1].getName(), values[3].getName(), new CompositeExpression(values[5])); }),
    get('class', 'Name', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.klass(values[1].getName(), new CompositeExpression(values[3])); }),

    // Module
    
    get('module', 'Name', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.module(values[1].getName(), new CompositeExpression(values[3])); }),
    ...
    get('def', 'Name', 'LeftParenthesis', 'RightParenthesis', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.def(values[1].getName(), [], new CompositeExpression(values[5])); }),
    get('def', 'Name', 'LeftParenthesis', 'NameList', 'RightParenthesis', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.def(values[1].getName(), values[3], new CompositeExpression(values[6])); }),
    get('def', 'Name', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.def(values[1].getName(), [], new CompositeExpression(values[3])); }),
    ...
    // If, Unless and Suite
    get('if', 'Expression', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.if(values[1], new CompositeExpression(values[3])); }),
    get('if', 'Expression', 'EndOfStatement', 'Suite', 'else', 'Suite', 'end').generate('Expression', function (values) { return x.if(values[1], new CompositeExpression(values[3]), new CompositeExpression(values[5])); }),
    get('unless', 'Expression', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.unless(values[1], new CompositeExpression(values[3])); }),
    get('unless', 'Expression', 'EndOfStatement', 'Suite', 'else', 'Suite', 'end').generate('Expression', function (values) { return x.unless(values[1], new CompositeExpression(values[3]), new CompositeExpression(values[5])); }),
    ...
    // While and Suite
    get('while', 'Expression', 'do', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.while(values[1], new CompositeExpression(values[4])); }),
    get('while', 'Expression', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.while(values[1], new CompositeExpression(values[3])); }),
    
    // Until and Suite
    get('until', 'Expression', 'do', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.until(values[1], new CompositeExpression(values[4])); }),
    get('until', 'Expression', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.until(values[1], new CompositeExpression(values[3])); }),
...
//    get('Call').generate('Term'),
    get('Name', 'LeftBracket', 'ExpressionList', 'RightBracket').generate('Term', function (values) { return x.indexed(values[0], values[2]); }),
    ...
    get('BinaryNot', 'Expression2').generate('Expression2', function (values) { return new BinaryNotExpression(values[1]); }),
    get('Expression2', 'Equal', 'Expression1').generate('Expression2', function (values) { return x.eq(values[0], values[2]); }),
    get('Expression2', 'NotEqual', 'Expression1').generate('Expression2', function (values) { return x.noteq(values[0], values[2]); }),
    ...
    get('Expression0', 'Modulus', 'Term').generate('Expression0', function (values) { return x.mod(values[0], values[2]); }),
    get('Expression0', 'Power', 'Term').generate('Expression0', function (values) { return x.power(values[0], values[2]); }),
    
    // Term
    get('Term').generate('Expression0'),
    get('Term', 'LeftBracket', 'ExpressionList', 'RightBracket').generate('Term', function (values) { return x.indexed(values[0], values[2]); }),
    ...
    get('LeftBracket', 'RightBracket').generate('Array', function (values) { return x.array([]); }),
    get('LeftBracket', 'ExpressionList', 'RightBracket').generate('Array', function (values) { return x.array(values[1]); }),
