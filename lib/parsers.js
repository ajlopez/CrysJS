...
var ClassExpression = x.ClassExpression,
    ...
    EqualExpression = x.EqualExpression,
    NotEqualExpression = x.NotEqualExpression,
    LessExpression = x.LessExpression,
    GreaterExpression = x.GreaterExpression,
    LessEqualExpression = x.LessEqualExpression,
    LessEqualGreaterExpression = x.LessEqualGreaterExpression,
    GreaterEqualExpression = x.GreaterEqualExpression,
    AddExpression = x.AddExpression,
    SubtractExpression = x.SubtractExpression,
    MultiplyExpression = x.MultiplyExpression,
    DivideExpression = x.DivideExpression,
    ModulusExpression = x.ModulusExpression,
